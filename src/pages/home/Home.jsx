...
export const Home = () => {
  ...
  return (
    <chakra.div backgroundColor={useColorModeValue("white", "blackAlpha.700")}>
      ...
      <Flex
        backgroundColor={useColorModeValue("blackAlpha.900", "whiteAlpha.300")}
        py={10}
        px={[0, 0, 10]}
        gap={[1, 3, 5]}
        align="center"
      ...
      <Flex
        p={10}
        marginInline={["0rem", "1rem", "3.3rem"]}
        my={10}
        justify={["center", "center", "space-between"]}
        align="center"
        gap={{ base: "2.5rem", sm: "3rem", md: "4rem", lg: "5rem" }}
      >
        <VStack align="left" gap={{ base: 2, sm: 4, md: 6, lg: 10 }}>
          <SideCard
            icon={FaRegEdit}
      ...
      <Flex width="full" justify="center" align="center" marginBlock="4rem">
        <Card
          backgroundColor={useColorModeValue(
            "blackAlpha.900",
            "whiteAlpha.300"
